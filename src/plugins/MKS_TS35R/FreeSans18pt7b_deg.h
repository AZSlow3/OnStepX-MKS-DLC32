// Like original, but with degreee (°) character instead of (`)
const uint8_t FreeSans18pt7bBitmaps_deg[] PROGMEM = {
  ...
  0x03, 0x80, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xC0, 0x38, 0x8B, 0x0B, 0x23,
  0x80, 0x07, 0xF0, 0x0F, 0xFC, 0x0F, 0xFF, 0x0F, 0x03, 0xC7, 0x00, 0xE0,
...
const GFXglyph FreeSans18pt7bGlyphs_deg[] PROGMEM = {
  {     0,   0,   0,   9,    0,    1 },   // 0x20 ' '
  {     0,   3,  26,  12,    4,  -25 },   // 0x21 '!'
  {    10,   9,   9,  12,    1,  -24 },   // 0x22 '"'
...
const GFXfont FreeSans18pt7b_deg PROGMEM = {
  (uint8_t  *)FreeSans18pt7bBitmaps_deg,
  (GFXglyph *)FreeSans18pt7bGlyphs_deg,
  0x20, 0x7E, 42 };
